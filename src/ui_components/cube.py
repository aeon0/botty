...
import keyboard
from ui.ui_manager import detect_screen_object, hover_over_screen_object_match, ScreenObjects
...
def open() -> TemplateMatch:
    ...
    if match.valid:
        ...
        mouse.click("right")
        wait(0.1)
        return detect_screen_object(ScreenObjects.CubeOpened)
    return None
...
if __name__ == "__main__":
    m = detect_screen_object(ScreenObjects.CubeInventory)
    if m.valid:
        m = open()
