...
class TownManager:
    ...
    def go_to_act(self, act_idx: int, curr_loc: Location) -> Union[Location, bool]:
        ...
        if act_idx == 1:
            act = Location.A1_TOWN_START
        elif act_idx == 2:
            act = Location.A2_TOWN_START
        elif act_idx == 3:
            act = Location.A3_TOWN_START
        elif act_idx == 4:
            act = Location.A4_TOWN_START
        elif act_idx == 5:
    ...
    def buy_pots(
        self, curr_loc: Location, healing_pots: int = 0, mana_pots: int = 0
    ) -> Union[Location, bool]:
        curr_act = TownManager.get_act_from_location(curr_loc)
        if curr_act is None:
            return False
...
if __name__ == "__main__":
    ...
    town_manager = TownManager(
        template_finder, ui_manager, item_finder, a1, a2, a3, a4, a5
    )
