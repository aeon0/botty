        ...
        if filename.endswith(".png"):
            ...
            for key in game_color_ranges:
                ...
                for count, cntr in enumerate(contours):
                    ...
                    correct_height = 1 if (contour_height[0] < h < contour_height[1]) else 0
                    correct_width = 1 if (contour_width[0] < w < contour_width[1]) else 0
                    if contains_black and is_dark and correct_height and correct_width:
                        cv2.rectangle(show_img, (x, y), (x+w, y+h), (0, 255, 0), 1)

                cv2.imwrite(f"./generated/{filename}_{key}_rectangles.png", show_img)
