    ...
    for filename in os.listdir(args.file_path):
        if filename.endswith(".png"):
            ...
            for count, cntr in enumerate(contours):
                ...
                if contains_black and is_dark and (contour_height[0] < h < contour_height[1]) and (contour_width[0] < w < contour_width[1]):
                    cv2.rectangle(inp_img, (x, y), (x+w, y+h), (0, 255, 0), 1)

            cv2.imwrite(f"./generated/{filename}_rectangles.png", inp_img)
