...
class Config:
    ...
    def __init__(self):
        ...
        self.char = {
            ...
            "take_rv_potion_health": float(self._select_val("char", "take_rv_potion_health")),
            "take_rv_potion_mana": float(self._select_val("char", "take_rv_potion_mana")),
            "heal_merc": float(self._select_val("char", "heal_merc")),
            "heal_rv_merc": float(self._select_val("char", "heal_rv_merc")),
            ...
            "beltCols": self._select_val("char","beltCols"),
