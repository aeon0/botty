...
class Screen:
    ...
    def __init__(self, monitor: int = 0):
        ...
        if self._config.advanced_options["offset_top"] and self._config.advanced_options["offset_left"]:
            offset_top = int(self._config.advanced_options["offset_top"])
            offset_left = int(self._config.advanced_options["offset_left"])
            Logger.debug(f"Custom offsets: left {offset_left}px, top {offset_top}px")
        else:
            # auto find offests
