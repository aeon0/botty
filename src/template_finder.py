...
class TemplateFinder:
    def __init__(self, screen: Screen, scale_factor: float = None):
        ...
        self._templates = {
            ...
            # NPC: Larzuk
            "LARZUK_FRONT": [load_template("assets/npc{res_str}/larzuk/larzuk_front.png", 1.0), 1.0],
            "LARZUK_BACK": [load_template("assets/npc{res_str}/larzuk/larzuk_back.png", 1.0), 1.0],
            "LARZUK_SIDE": [load_template("assets/npc{res_str}/larzuk/larzuk_side.png", 1.0), 1.0],
            "LARZUK_SIDE_2": [load_template("assets/npc{res_str}/larzuk/larzuk_side_2.png", 1.0), 1.0],
            "LARZUK_SIDE_3": [load_template("assets/npc{res_str}/larzuk/larzuk_side_3.png", 1.0), 1.0],
            "LARZUK_NAME_TAG_WHITE": [load_template("assets/npc{res_str}/larzuk/larzuk_white.png", 1.0), 1.0],
            "LARZUK_NAME_TAG_GOLD": [load_template("assets/npc{res_str}/larzuk/larzuk_gold.png", 1.0), 1.0],
            "LARZUK_TRADE_REPAIR_BTN": [load_template("assets/npc{res_str}/larzuk/trade_repair_btn.png", 1.0), 1.0],
            # NPC: Anya
            "ANYA_FRONT": [load_template("assets/npc{res_str}/anya/anya_front.png", 1.0), 1.0],
            "ANYA_BACK": [load_template("assets/npc{res_str}/anya/anya_back.png", 1.0), 1.0],
            "ANYA_SIDE": [load_template("assets/npc{res_str}/anya/anya_side.png", 1.0), 1.0],
            "ANYA_NAME_TAG_GOLD": [load_template("assets/npc{res_str}/anya/anya_gold.png", 1.0), 1.0],
            "ANYA_NAME_TAG_WHITE": [load_template("assets/npc{res_str}/anya/anya_white.png", 1.0), 1.0],
            "ANYA_TRADE_BTN": [load_template("assets/npc{res_str}/anya/trade_btn.png", 1.0), 1.0],
        }
