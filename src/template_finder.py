...
class TemplateFinder:
    def __init__(self, screen: Screen, scale_factor: float = None):
        ...
        self._templates = {
            ...
            "YOU_HAVE_DIED":[load_template(f"assets/templates/you_have_died.png", 1.0, alpha=True), 1.0],
            # NPC: Qual-Kehk
            "QUAL_FRONT": [load_template(f"assets/npc/qual_kehk/qual_front.png", 1.0, alpha=True), 1.0],
            "QUAL_SIDE": [load_template(f"assets/npc/qual_kehk/qual_side.png", 1.0, alpha=True), 1.0],
            "QUAL_BACK": [load_template(f"assets/npc/qual_kehk/qual_back.png", 1.0, alpha=True), 1.0],
            "QUAL_45": [load_template(f"assets/npc/qual_kehk/qual_45.png", 1.0, alpha=True), 1.0],
            "QUAL_45_2": [load_template(f"assets/npc/qual_kehk/qual_45_2.png", 1.0, alpha=True), 1.0],
            "QUAL_45_3": [load_template(f"assets/npc/qual_kehk/qual_45_3.png", 1.0, alpha=True), 1.0],
            ...
            # NPC: Malah
            "MALAH_FRONT": [load_template(f"assets/npc/malah/malah_front.png", 1.0, alpha=True), 1.0],
            "MALAH_BACK": [load_template(f"assets/npc/malah/malah_BACK.png", 1.0, alpha=True), 1.0],
            "MALAH_45": [load_template(f"assets/npc/malah/malah_45.png", 1.0, alpha=True), 1.0],
            "MALAH_SIDE": [load_template(f"assets/npc/malah/malah_side.png", 1.0, alpha=True), 1.0],
            "MALAH_SIDE_2": [load_template(f"assets/npc/malah/malah_side_2.png", 1.0, alpha=True), 1.0],
            ...
            # NPC: Larzuk
            "LARZUK_FRONT": [load_template(f"assets/npc/larzuk/larzuk_front.png", 1.0, alpha=True), 1.0],
            "LARZUK_BACK": [load_template(f"assets/npc/larzuk/larzuk_back.png", 1.0, alpha=True), 1.0],
            "LARZUK_SIDE": [load_template(f"assets/npc/larzuk/larzuk_side.png", 1.0, alpha=True), 1.0],
            "LARZUK_SIDE_2": [load_template(f"assets/npc/larzuk/larzuk_side_2.png", 1.0, alpha=True), 1.0],
            "LARZUK_SIDE_3": [load_template(f"assets/npc/larzuk/larzuk_side_3.png", 1.0, alpha=True), 1.0],
            ...
            # NPC: Anya
            "ANYA_FRONT": [load_template(f"assets/npc/anya/anya_front.png", 1.0, alpha=True), 1.0],
            "ANYA_BACK": [load_template(f"assets/npc/anya/anya_back.png", 1.0, alpha=True), 1.0],
            "ANYA_SIDE": [load_template(f"assets/npc/anya/anya_side.png", 1.0, alpha=True), 1.0],
