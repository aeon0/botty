...
class Diablo:
    ...
    def _seal_A1(self) -> bool:
        ...
        if not self._sealdance(["DIA_A1L2_14_OPEN"], ["DIA_A1L2_14_CLOSED", "DIA_A1L2_14_MOUSEOVER"], seal_layout + "- Fake"): return False
        ...
        Logger.info("Kill Sealboss A: Vizier")
    ...
    def _seal_B1(self): #NEW & dirty
        ...
        Logger.info("Kill Sealboss B: De Seis")
    ...
    def _seal_C1(self) -> bool: # The boss Seal takes several tries to recognize. Maybe we need new templates
        ...
        Logger.info("Kill Sealboss C: Infector")
