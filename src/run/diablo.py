...
class Diablo:
    ...
    def _seal_A1(self) -> bool:
        ...
        self._picked_up_items |= self._pickit.pick_up_items(self._char)
        #if not self._pather.traverse_nodes([610], self._char): return False # removed, as it causes teleport to nirvana if 610 is not found anymore after looting.
...
# issue log:
# A1L - if vizier spawns at 610 pr 611 you tele to nirvana -> seems like the pickup brings us outside the calibration place. solution not to calibrate at A1L end & hope pent looping brings us home?
