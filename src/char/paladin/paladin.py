import keyboard
from ui.skills import SkillName, is_right_skill_selected, is_right_skill_active
import time
import random
...
class Paladin(IChar):
    ...
    def _cast_skill_with_aura(self, skill_name: SkillName, cast_pos_abs: tuple[float, float] = None, spray: int = 0, min_duration: float = 0, aura: SkillName=None):
    ...
    def _activate_cleanse_aura(self, delay = [0.3, 0.4]):
        self._select_skill(SkillName.Cleansing, delay=delay)
